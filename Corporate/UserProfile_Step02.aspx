<%@ Page Language="C#" MasterPageFile="~/Corporate/MPCorporate1.master" AutoEventWireup="true" CodeFile="UserProfile_Step02.aspx.cs" Inherits="Corporate_UserProfile_Step02" Title="www.boromela.com : User Registration." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
             <td>&nbsp;</td>
             <td height="20" align="right" valign="bottom"><div  class="step">Step 2 of 3</div></td>
             </tr>
        </table>
        <br /><br />
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cptable" style="border-top:1px solid #EFEFE2;">
            ...
            We have sent and email to your address&nbsp;<asp:Label ID="lblEmailAddress" runat="server" ForeColor="#365EBF"></asp:Label>
            </li>
            ...
            <li>
            Don’t forget to check your spam/bulk mail folder if your Inbox is empty.
            </li>
            </ul>
            </td>
            </tr> 
