<%@ Page Language="C#" MasterPageFile="~/Corporate/MPCorporate2.master" AutoEventWireup="true" CodeFile="UserProfile_ChangeLoginInfo.aspx.cs" Inherits="Corporate_UserProfile_ChangeLoginInfo" Title="www.boromela.com - Change Login Info." %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cptable" style="border-top:1px solid #EFEFE2;">
    ...
    <tr>
    <td style="height: 25px">Confirm new Password:<span class="mandatory">*</span></td>
