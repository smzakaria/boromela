...
public partial class Corporate_SellLead_Books : System.Web.UI.Page
{
    ...
    private void GetSellLead_BuyerList()
    {
        ...
        using (BOC_Corporate_ProdProf_Book bocProductProfile = new BOC_Corporate_ProdProf_Book())
        {
            ...
            grvSellLead01.DataSource = bocProductProfile.SellLead_Set01_BuyerList_Books(eocPropertyBean);
