<%@ Page Language="C#" MasterPageFile="~/Corporate/MPCorporate1.master" AutoEventWireup="true" CodeFile="UserProfile_Step03.aspx.cs" Inherits="Corporate_UserProfile_Step03" Title="www.boromela.com : User Registration." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <%if(this.intActionResult > 0){ %>
            ...
            <span class="pageTitle">Congratulation!</span> &nbsp; You have successfully register with www.boromela.com
            <br />
        <%} %>
