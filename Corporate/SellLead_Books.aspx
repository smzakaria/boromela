<%@ Page Language="C#" MasterPageFile="~/Corporate/MPCorporate2.master" AutoEventWireup="true" CodeFile="SellLead_Books.aspx.cs" Inherits="Corporate_SellLead_Books" Title="www.boromela.com – Sell Lead (Book)." %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<span class="pageTitle">Corporate - Sell Lead (Books).</span>
<br /><br /><br />
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cptable" style="border-top:1px solid #EFEFE2;" id="TABLE1">
    ...
    <asp:Button ID="btnSellLead1" runat="server" Text="Show Sell Lead" OnClick="btnSellLead1_Click" BorderStyle="Groove" />
    </td>
    </tr>    
</table>
<%if(grvSellLead01.Rows.Count >0){ %>
    <br />
    <strong>Total Pending Orders (Buyer wise view):</strong>
    <br /><br />
<%} %>
<asp:GridView 
    ID="grvSellLead01" 
    ...
    PageSize="10" 
    Font-Size="11px" 
    OnPageIndexChanging="grvSellLead01_PageIndexChanging">    
    ...
    <Columns>
        ...
        <asp:HyperLinkField 
            ...
            DataNavigateUrlFormatString="SellLead_Books_Confirmation.aspx?Email={0}&Buyer={1}"
