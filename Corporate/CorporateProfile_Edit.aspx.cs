...
public partial class Corporate_CorporateProfile_Edit : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            strSystemMessage = "This Company Name already registered with boromela.com";
            strSystemMessage += "<br/><br/>";
            strSystemMessage += "<strong>How did this happen? </strong>";
            strSystemMessage += "<ul>";
            strSystemMessage += "<li>You may have already registered with www.boromela.com earlier but forgot about it.</li>";
            strSystemMessage += "<li>Someone else, may have signed up for a boromela corporate account with this Company Name.</li>";
            strSystemMessage += "</ul>";
