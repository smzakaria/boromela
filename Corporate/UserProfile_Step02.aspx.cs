                ...
                else
                {
                    if (intActionResult > 0)
                    {
                        ...
                        if (dtActivationLink.Rows.Count > 0)
                        {
                            ...
                            mailBody += "Thank you for registration at <a href=\"http://www.boromela.com\"> www.boromela.com</a> ! We are pleased to welcome you to our service and we hope that you will find it very valuable and useful.";
                            mailBody += "<br/><br/>";
                            mailBody += "Your new account has been created, and only one more step is needed to complete the registration process.";
                            mailBody += "<br/>";
                            mailBody += "Please click <a href=\"http://www.boromela.com/corporate/UserProfile_Step03.aspx?LinkCode=" + httpObject.UrlEncode(linkID) + "&ProfileCode=" + httpObject.UrlEncode(profileID) + "\">here</a> to complete the verification.";
                            mailBody += "<br/><br/>";
                            mailBody += "If you are unable to click the link above, please copy and paste the following link into your browser window:";
                            mailBody += "<br/><br/>";
                            mailBody += "http://www.boromela.com/corporate/UserProfile_Step03.aspx?LinkCode=" + httpObject.UrlEncode(linkID) + "&ProfileCode=" + httpObject.UrlEncode(profileID);
                            mailBody += "<br/><br/>";
                            mailBody += "Best regards,";
                            mailBody += "<br/><br/>";
                            mailBody += "boromela.com Team";
                            mailBody += "<br/><br/>";
                            ...
                            mailMaster.MailFrom = "admin@boromela.com";
                            mailMaster.MailSubject = "Activate your www.boromela.com account.";
