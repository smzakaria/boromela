...
public partial class Common_MPCommon : System.Web.UI.MasterPage
{
    // Website pages considered to be "catalog pages" that the visitor
    // can "Continue Shopping" to
    private static string[] catalogPages = { "~/Common/Default.aspx", "~/Common/ItemList_Books.aspx", "~/Common/ItemDetail_Books.aspx", "~/Common/UsedAndNew_Books.aspx" };
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["COUNTRY"] != null)
        {
            ...
            lblLocation.Text += Session["COUNTRY"].ToString() + "</a>";
        }
        else
        {
